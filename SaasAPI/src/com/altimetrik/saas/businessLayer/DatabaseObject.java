...
public class DatabaseObject {
	...
	public DatabaseObject(Long invoiceNo,Date invoiceDate,Long customerPO,String address,Double totalCost,String senderEmail,String status){
	...
	public String toString(){
		...
		String customerPO = "customerPO : " + Long.toString(this.customerPO) + "\n";
